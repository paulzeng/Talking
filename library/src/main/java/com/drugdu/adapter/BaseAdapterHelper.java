...
public class BaseAdapterHelper
{
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public BaseAdapterHelper setImageResourceID(int viewId, int imageResId)
	{
	 ...
	 * @return The BaseAdapterHelper for chaining.
	 */
	public BaseAdapterHelper setImageResource(int viewId, String imageUrl)
	{
		ImageView view = retrieveView(viewId);
		//ImageManager.getInstance().displayImage(imageUrl, view, options);
		Glide.with(context)
				.load(imageUrl)
				.into(view);
		return this;
	 ...
	 * @return
	 */
	public BaseAdapterHelper setImageResource(int viewId, int imageId)
	{
		ImageView view = retrieveView(viewId);
		//Picasso.with(context).load(imageUrl).into(view);
		Glide.with(context)
