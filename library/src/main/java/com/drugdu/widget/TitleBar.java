...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private int mHeight,mSearchHeight;
    ...
    private void initView(Context context) {
        ...
        mLeftText.setTextColor(UIUtils.getColor(R.color.white));
        ...
        mCenterLayout.addView(searchText);
        ...
        mCenterText.setTextColor(UIUtils.getColor(R.color.white));
    ...
    private void initSearchView(){
        //默认设置不可见
        searchText.setTextSize(DEFAULT_ACTION_TEXT_SIZE);
        searchText.setCompoundDrawablesWithIntrinsicBounds(R.drawable.search,0,0,0);
        searchText.setCompoundDrawablePadding(mOutPadding);
        searchText.setTextColor(UIUtils.getColor(R.color.main_text_color));
        searchText.setBackgroundResource(R.drawable.bg_searchview);
        searchText.setHeight(mSearchHeight);
        searchText.setText("Search Something You Like ...");
        searchText.setTextSize(12);
        searchText.setPadding(mOutPadding, 0, mOutPadding, 0);
        searchText.setGravity(Gravity.LEFT|Gravity.CENTER_VERTICAL);
        //设置权重
        searchText.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT, 1.0f));
    ...
    public void setLeftImageResource(int resId) {
        ...
        mLeftText.setCompoundDrawablePadding(3);
    }
    ...
    private View inflateAction(Action action) {
        ...
        view.setPadding(mActionPadding, 0, 0, 0);
        view.setTag(action);
    ...
    /**
     * 设置带有左右图标和搜索框的titlebar
     * @param leftId
     * @param rightId
     * @param leftOnclick
     * @param rightOnclick
     */
    public void setSearchTitle(int leftId,int rightId,final OnClickListener leftOnclick, final OnClickListener rightOnclick){
        //隐藏不需要的控件
        mCenterText.setVisibility(View.GONE);
        mSubTitleText.setVisibility(View.GONE);
